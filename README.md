...
本專案完全相容於 [Vercel Labs Skills](https://github.com/vercel-labs/skills) 生態規範。您可透過 Vercel 官方技能管理工具一鍵安裝這些技能：
...
*   **防範漂綠與金融融資對接**：引導企業防範口號式宣傳產生的「漂綠 (Greenwashing)」法律風險。針對綠色專案聯貸與融資，提供「赤道原則 (EPs)」、「責任投資 (UN PRI)」之實務對接診斷，並為財務窗口提供 CFA ESG 證照建議。
*   **前沿 ESG AI 與動態輿情監控**：引入基於 GDELT Project 及 Node2Vec 大數據技術之動態輿情監測，使企業與金融機構能動態評估同業傳染風險與全球媒體情緒語調 (Sentiment Tone)，預防潛在的漂綠控訴。
...
└── skills/
    ├── references/
    │   └── taiwan_esg_regulatory_reference.md  # 台灣 ESG 官方權威法規對照指南（含細部法規、金融對接與 ESG AI 工具）
...
*   **範例提問**：
    ...
    *   > *「我們公司在對外宣傳碳中和，有沒有漂綠（Greenwashing）風險？另外我們需要低碳更新專案融資，銀行會用什麼標準審查我們的 ESG 報告？」*
...
*   **範例提問**：
    ...
    *   > *「大型國際品牌供應鏈（如 Apple 廠商），除了 ISO 碳盤查證照，還需要具備什麼 ESG AI 或大數據分析能力？財務經理建議考取什麼證照對接綠色融資？」*
...
本專案技能之推理邏輯高度依賴本機 [台灣 ESG 官方權威法規對照指南](skills/references/taiwan_esg_regulatory_reference.md)。其法源與倡議依據包括：
*   **金管會與證交所**：[《上市/上櫃公司編製與申報永續報告書作業辦法》](https://twse-regulation.twse.com.tw/m/LawContent.aspx?FID=FL075209)、[《公開發行公司年報應行記載事項準則》](https://twse-regulation.twse.com.tw/TW/law/DAT0201.aspx?FLCODE=FL007032)、各類實務與風險管理守則。
*   **國際倡議與大數據**：赤道原則 (EPs)、UN PRI 責任投資原則、GDELT Project 全球輿情大數據監測。
